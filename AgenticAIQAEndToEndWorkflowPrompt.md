...
- Use stable element properties (IDs, data attributes, roles) discovered during manual testing
- Apply wait strategies and UI behaviors observed during exploratory testing
...
## ▶️ STEP 5: Execute and Heal Automation Tests
...
```
I want to demonstrate a complete end-to-end QA workflow using natural language, multiple agents and MCP servers.
...
Read the test plan from specs/saucedemo-checkout-test-plan.md and use Playwright browser tools to manually execute each test scenario from the plan. Document findings with screenshots and note any issues discovered.
...
- All files committed and pushed to Git repository
- Summary of the complete workflow execution with results after each step
